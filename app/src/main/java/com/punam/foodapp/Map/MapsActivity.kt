...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private var lstLatLang = mutableListOf<LattiLongi>()
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        mMap = googleMap
        lstLatLang.add(LattiLongi(27.7062581,85.3300012, "Block E"));
        lstLatLang.add(LattiLongi(27.7057244,85.3279674, "Block C"));
